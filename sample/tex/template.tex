...
% Use times package (simpler than mathptmx, no rsfs dependency)
\usepackage{times}             % Times serif for body
\usepackage[scaled=0.92]{helvet} % Helvetica for sans-serif elements
% Use default CM typewriter font instead of courier
...
Example citation format: Prior work has examined this topic\cite{Smith2023,Jones2022}.
...
%% =============================================================================
%%  SUPPLEMENT (auto-generated from Stage 5 analysis_results.json)
%% =============================================================================
\clearpage
\section*{Supplement 1}

% Content will be auto-generated by write-paper skill including:
% - eAppendix 1: Statistical Model Specification (model equations, variable definitions, software)
% - eAppendix 2: Model Assumption Checks and Diagnostic Results (fit statistics, assumption tests)
% - eTable 1: Full Model Results (complete coefficient table with all covariates)
% - eTable 2: Sensitivity Analysis Summary (if applicable)
%
% Do not modify this section manually; it is populated from 3_analysis/analysis_results.json

\subsection*{eAppendix 1. Statistical Models and Methods Details}
% Auto-generated: Model equation in LaTeX math format, variable definitions,
% software and packages used, estimation method description

\subsection*{eTable 1. Full Model Results}
% Auto-generated: Complete coefficient table with all covariates from
% analysis_results.json -> primary_analysis.models

\subsection*{eTable 2. Sensitivity Analysis Summary}
% Auto-generated: Comparison of primary analysis vs sensitivity analyses
% (only included if sensitivity_analyses array is non-empty)

\subsection*{eFigure 1. Supplementary Figure Title}
% Insert supplementary figure here if additional figures exist in 4_figures/
